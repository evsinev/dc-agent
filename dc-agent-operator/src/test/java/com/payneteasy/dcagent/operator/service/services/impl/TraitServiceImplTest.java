...
import static com.payneteasy.dcagent.operator.service.services.impl.TraitServiceImpl.formatAge;
...
public class TraitServiceImplTest {
    ...
    public void format_age() {
        ...
        assertEquals("6M28D", formatAge(1_718_062_368_000L, new Date(1700002368_000L)));
    }
}